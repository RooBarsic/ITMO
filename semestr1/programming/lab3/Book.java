...
class Book implements GetName, GetJanr {
    ...
    Book(String name, Janrs jan, int kol, String[] arr) {
        if((name == null) || (jan == null) || (kol < 0)) throw new IllegalArgumentException(" in Book.Book");
        bookName = name;
        bookJanr = jan;
    ...
    public boolean equals(Object o) {
        ...
        Book book = (Book) o;
        return mxKolWords == book.mxKolWords &&
                Objects.equals(bookName, book.bookName) &&
                bookJanr == book.bookJanr &&
                Objects.equals(words, book.words);
    }
