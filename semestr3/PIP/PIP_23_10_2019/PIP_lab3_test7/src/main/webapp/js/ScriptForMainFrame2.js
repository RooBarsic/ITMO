...
jQuery(document).ready(function(){
    ...
    alert(" set listener on R changing");
...
function addToTable(xx, yy, rr, result, timeToWork) {
    // var id = "mutant";
    ...
    document.getElementById('CVform:CVvalueX').value = xx;
    document.getElementById('CVform:CVvalueY').value = yy;
    document.getElementById('CVform:CVvalueR').value = rr;
