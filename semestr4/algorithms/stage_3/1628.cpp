...
области белых У. При нахождении области с длиной > 1 - 
увеличим ответ на 1. Иначе - запомним координаты этой белой
точки.

Теперь сгрупируем точки по У координатам, и для них сделаем 
тоже-что и в первом случае. Но если встретим белую полосу - длинной
1, то проверим "запоминали ли мы эту точку?", если да, то ans++
